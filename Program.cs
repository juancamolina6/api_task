...
namespace MiProyecto
{
    ...
    {
        private readonly string _connectionString = "Host=127.0.0.1;Username=postgres;Password=1234567890;Database=list_tasks;Port=5432";
        ...
        public async Task<ActionResult> SearchTask(int id)
        {
            try
            {
                ...
                using var cmd = new NpgsqlCommand("SELECT * FROM tasks WHERE id_task = @idTask", conn);
